...
router.get('/get-receipts', sales_receipts_controller_1.getReceipts);
router.get('/get-receipt/:id', sales_receipts_controller_1.getReceiptTById);
router.get('/generated-receipt', sales_receipts_controller_1.generatedReceipts);
/* REPORTES */
